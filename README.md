...
## Environments
- Preview: https://main--adapt2test--balasoiuroxana.aem.page/
- Live: https://main--adapt2test--balasoiuroxana.aem.live/
...
1. Open the `adapt2test` directory in your favorite IDE and start coding :)
